...
- For most bioinformatics tools, you have to use the shell. There is no graphical interface. If you want to work in massive pangenomes, you must use the shell.
- The shell gives you power. The command line gives you the power to do your work more efficiently and more quickly. When you need to do things tens to hundreds of times, knowing how to use the shell is transformative.
- You need to use the shell to use remote computers or cloud computing.
...
> AMI. Information on setting up an AMI and accessing the required data is provided on the [Pangenomics Workshop Setup page](https://czirion.github.io/pangenomics-workshop/setup.html). FIXME 💢
{: .prereq}

> ## For Instructors
>
> If you are teaching this lesson in a workshop, please see the 
> [Instructor notes](https://czirion.github.io/pangenomics-workshop/guide/index.html). FIXME 💢
{: .prereq}
